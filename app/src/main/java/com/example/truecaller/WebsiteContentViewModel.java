...
public class WebsiteContentViewModel extends ViewModel {
    ...
    public void fetchWebsiteContent(String url) {
        repository.fetchWebsiteContent(url, contentResult);
    ...
    private List<Character> performTask2() {
    ...
    private Map<String, Integer> performTask3() {
